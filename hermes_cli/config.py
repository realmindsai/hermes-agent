...
DEFAULT_CONFIG = {
    ...
    "stt": {
        "enabled": True,
        "provider": "local",  # "local" (free, faster-whisper) | "parakeet" (HTTP service) | "groq" | "openai" (Whisper API) | "mistral" (Voxtral Transcribe)
        "local": {
            "model": "base",  # tiny, base, small, medium, large-v3
            "language": "",  # auto-detect by default; set to "en", "es", "fr", etc. to force
        },
        "parakeet": {
            "base_url": "",  # External Parakeet STT endpoint, e.g. http://172.17.0.1:8770
        },
        "openai": {
